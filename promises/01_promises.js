...
export function returnValuesWithPromise() {
  ...
  */
  var promise = new Promise(function (resolve, reject) {
    ...
    */
    console.log(1);
    //llamando al servidor si todo sale bien, llamamos al resolve y si todo sale mal llamanos al reject
...
export function returnValuesWithParallelPromises() {
  ...
  return Promise.all(requestsList).then(function (results) {
...
export function returnValuesFirstOtherPromises() {
  ...
  var getUserInfoFromAnotherServer = function (userId) {
    ...
    // return Promise.resolve({ id: 1, name: "Eli", serverName: "server2" });
  };
  ...
  return Promise.race(requestsList).then(function (response) {
